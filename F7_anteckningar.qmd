...
**Modell:** $X$ är en Normalfördelad slumpvariabel med okänt väntevärde $\mu$ och känd standardavvikelse $\sigma$
...
n = 3
k = 0.2+1.64*0.07/sqrt(n)
df$styrka_mu_n3 <- 1 - pnorm((k-df$mu)/(0.07/sqrt(n))) #styrka då n=3
n = 6
k = 0.2+1.64*0.07/sqrt(n)
df$styrka_mu_n6 <- 1 - pnorm((k-df$mu)/(0.07/sqrt(n)))
...
(b) Vad är testets styrka när grumligheten är 4.3? 
