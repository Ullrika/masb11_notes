...
**Model:** $X$ is a normally distributed random variable with unknown expected value $\mu$ and known standard deviation $\sigma$
...
df$styrka_mu_n3 <- 1 - pnorm((k-df$mu)/(0.07/sqrt(n))) # power when n=3
n = 6
k = 0.2+1.64*0.07/sqrt(n)
